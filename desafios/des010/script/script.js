...
function calcularX() {
    ...
    segundoResultado.innerHTML += `<p>O primeiro valor calculado foi <strong>x1 = ${positivo.toFixed(5)}</strong></p>`
    segundoResultado.innerHTML += `<p>O segundo valor calculado foi <strong>x2 = ${negativo.toFixed(5)}</strong></p>`
}